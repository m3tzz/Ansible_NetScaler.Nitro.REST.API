...
RETURN = '''
all_existing:
    description: All existing monitor bindings for the service group.
    returned: always
    type: list
    sample: [{"monitor_name": "monitor_app01", "servicegroupname": "svcgrp_app01"}]
config:
    description: The configuration that was sent to the the Netscaler API. Existing bindings return an empty dict.
    returned: always
    type: dict
    sample: {"monitor_name": "monitor_app02", "servicegroupname": "svcgrp_app02"}
existing:
    description: The existing binding for the service group and monitor pair. New bindings return an empty dict.
    returned: always
    type: dict
    sample: {}
logout:
